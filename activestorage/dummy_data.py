...
def make_partially_missing_ncdata(
    filename="test_partially_missing_data.nc",
    chunksize=(3, 3, 1),
    n=10,
):
    """
...
def make_fillvalue_ncdata(
    filename="test_fillvalue.nc",
    chunksize=(3, 3, 1),
    n=10,
):
    """
...
def make_validmin_ncdata(
    filename="test_validmin.nc",
    chunksize=(3, 3, 1),
    n=10,
    valid_min=200.0,
):
...
def make_validmax_ncdata(
    filename="test_validmax.nc",
    chunksize=(3, 3, 1),
    n=10,
    valid_max=1.2 * 10**3,
):
...
def make_validrange_ncdata(
    filename="test_validrange.nc",
    chunksize=(3, 3, 1),
    n=10,
...
def make_compressed_ncdata(
    filename="test_vanilla.nc",
    chunksize=(3, 3, 1),
    n=10,
    compression=None,
    shuffle=False,
...
def make_ncdata(
    ...
    dtype_prefix = (
        "<" if byte_order == "little" else ">" if byte_order == "big" else ""
    )
    ...
    mindices, findices, vrindices, vm1indices, vm2indices = (
        None,
        None,
        None,
        None,
    ...
    print(
        f'\nCreated file "{filename}" with a variable called "data" with shape {var.shape} and chunking,'
        'compression {var.chunking()},{compression}\n',
    )
