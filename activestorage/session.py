...
from .remote import rFile
from .p5rem.protocol import CHUNK_DATA, CHUNKS_DONE, ERROR, FILE_INFO, FILE_CLOSE, FILE_OPEN, GET_CHUNK, GET_CHUNKS, HEARTBEAT, LIST, LIST_RESULT, REDUCE, REDUCTION_RESULT, STAT, STAT_RESULT, VAR_INFO, VAR_OPEN, read_message, write_message
...
try:
	from .p5rem.cache import get_default_cache
except ImportError:
